...
public class ActivityPickImage extends AppCompatActivity {
    ...
    private static final int STORAGE_READ_PERMISSION = 123;
    private static final int STORAGE_WRITE_PERMISSION = 321;
    private void checkStoragePermission() {
        ...
        if (ContextCompat.checkSelfPermission(this,
            ...
            // Request Location Permission
            ActivityCompat.requestPermissions(activity,
                    new String[]{Manifest.permission.READ_EXTERNAL_STORAGE}, STORAGE_WRITE_PERMISSION);
        }
    }
    ...
    public void onRequestPermissionsResult(int requestCode,
        ...
        if(requestCode == STORAGE_READ_PERMISSION || requestCode == STORAGE_WRITE_PERMISSION){
